...
static const struct opcode arm_opcodes[] =
{
    ...
    {0x012fff20, 0x0ffffff0, 0, "bxj%c\t%0-3R"},
    {0xf57ff01f, 0xffffffff, 0x000fff0f, "clrex"},
    {0x016f0f10, 0x0fff0ff0, 0, "clz%c\t%12-15R, %0-3R"},
    {0x01600010, 0x0fe00090, 0, "cmn%p%c\t%16-19R, %o"},
    {0x01600000, 0x0fe00010, 0, "cmn%p%c\t%16-19r, %o"},
    {0x03600000, 0x0fe00000, 0, "cmn%p%c\t%16-19r, %o"},
    {0x01400010, 0x0fe00090, 0, "cmp%p%c\t%16-19R, %o"},
    {0x01400000, 0x0fe00010, 0, "cmp%p%c\t%16-19r, %o"},
    {0x03400000, 0x0fe00000, 0, "cmp%p%c\t%16-19r, %o"},
    {0xf1000000, 0xfff1fe20, 0, "cps\t#%0-4d"},
    {0xf10c0000, 0xfffffe3f, 0, "cpsid\t%8'a%7'i%6'f"},
    {0xf10e0000, 0xfffffe20, 0, "cpsid\t%8'a%7'i%6'f,#%0-4d"},
    {0xf1080000, 0xfffffe3f, 0, "cpsie\t%8'a%7'i%6'f"},
    {0xf10a0000, 0xfffffe20, 0, "cpsie\t%8'a%7'i%6'f,#%0-4d"},
    {0xe1000040, 0xfff00ff0, 0, "crc32b\t%12-15R, %16-19R, %0-3R"},
    {0xe1000240, 0xfff00ff0, 0, "crc32cb\t%12-15R, %16-19R, %0-3R"},
    {0xe1200240, 0xfff00ff0, 0, "crc32ch\t%12-15R, %16-19R, %0-3R"},
    {0xe1400240, 0xfff00ff0, 0, "crc32cw\t%12-15R, %16-19R, %0-3R"},
    {0xe1200040, 0xfff00ff0, 0, "crc32h\t%12-15R, %16-19R, %0-3R"},
    {0xe1400040, 0xfff00ff0, 0, "crc32w\t%12-15R, %16-19R, %0-3R"},
    {0xe320f014, 0xffffffff, 0, "csdb"},
    {0x0320f0f0, 0x0ffffff0, 0, "dbg%c\t#%0-3d"},
    {0xf57ff050, 0xfffffff0, 0, "dmb\t%U"},
    {0xf57ff051, 0xfffffff3, 0, "dmb\t%U"},
    {0xf57ff040, 0xfffffff0, 0, "dsb\t%U"},
    {0xf57ff041, 0xfffffff3, 0, "dsb\t%U"},
    ...
    {0x0160006e, 0x0fffffff, 0, "eret%c"},
    {0xe320f010, 0xffffffff, 0, "esb"},
    {0xe1000070, 0xfff000f0, 0, "hlt\t0x%16-19X%12-15X%8-11X%0-3X"},
    {0x01400070, 0x0ff000f0, 0, "hvc%c\t%e"},
    {0xf57ff060, 0xfffffff0, 0, "isb\t%U"},
    {0x01900c9f, 0x0ff00fff, 0, "lda%c\t%12-15r, [%16-19R]"},
    {0x01d00c9f, 0x0ff00fff, 0, "ldab%c\t%12-15r, [%16-19R]"},
    {0x01900e9f, 0x0ff00fff, 0, "ldaex%c\t%12-15r, [%16-19R]"},
    {0x01d00e9f, 0x0ff00fff, 0, "ldaexb%c\t%12-15r, [%16-19R]"},
    {0x01b00e9f, 0x0ff00fff, 0, "ldaexd%c\t%12-15r, %12-15T, [%16-19R]"},
    {0x01f00e9f, 0x0ff00fff, 0, "ldaexh%c\t%12-15r, [%16-19R]"},
    {0x01f00c9f, 0x0ff00fff, 0, "ldah%c\t%12-15r, [%16-19R]"},
    ...
    {0x000000d0, 0x0e1000f0, 0, "ldrd%c\t%12-15r, %s"},
    {0x01900f9f, 0x0ff00fff, 0, "ldrex%c\tr%12-15d, [%16-19R]"},
    {0x01d00f9f, 0x0ff00fff, 0, "ldrexb%c\t%12-15R, [%16-19R]"},
    {0x01b00f9f, 0x0ff00fff, 0, "ldrexd%c\t%12-15r, [%16-19R]"},
    {0x01f00f9f, 0x0ff00fff, 0, "ldrexh%c\t%12-15R, [%16-19R]"},
    {0x04300000, 0x0d700000, 0, "ldrt%c\t%12-15R, %a"},
    {0x01a00000, 0x0def0060, 0, "lsl%20's%c\t%12-15R, %q"},
    {0x01a00020, 0x0def0060, 0, "lsr%20's%c\t%12-15R, %q"},
    {0x00200090, 0x0fe000f0, 0, "mla%20's%c\t%16-19R, %0-3R, %8-11R, %12-15R"},
    {0x00600090, 0x0ff000f0, 0, "mls%c\t%16-19R, %0-3R, %8-11R, %12-15R"},
    {0x01a00000, 0x0def0ff0, 0, "mov%20's%c\t%12-15r, %0-3r"},
    {0x03a00000, 0x0fef0000, 0, "mov%20's%c\t%12-15r, %o"},
    {0x03400000, 0x0ff00000, 0, "movt%c\t%12-15R, %V"},
    {0x03000000, 0x0ff00000, 0, "movw%c\t%12-15R, %V"},
    {0x01000000, 0x0fb00cff, 0, "mrs%c\t%12-15R, %R"},
    {0x0120f200, 0x0fb0f200, 0, "msr%c\t%C, %0-3r"},
    {0x0120f000, 0x0db0f000, 0, "msr%c\t%C, %o"},
    {0x00000090, 0x0fe000f0, 0, "mul%20's%c\t%16-19R, %0-3R, %8-11R"},
    {0x01e00010, 0x0fe00090, 0, "mvn%20's%c\t%12-15R, %o"},
    {0x01e00000, 0x0fe00010, 0, "mvn%20's%c\t%12-15r, %o"},
    {0x03e00000, 0x0fe00000, 0, "mvn%20's%c\t%12-15r, %o"},
    {0x03200000, 0x0fff00ff, 0, "nop%c\t{%0-7d}"},
    {0x0320f000, 0x0fffff00, 0, "nop%c\t{%0-7d}"},
    {0x0320f000, 0x0fffffff, 0, "nop%c\t{%0-7d}"},
    ...
    {0xf450f000, 0xfc70f000, 0, "pld\t%a"},
    {0xf410f000, 0xfc70f000, 0, "pldw\t%a"},
    {0xf450f000, 0xfd70f000, 0, "pli\t%P"},
    {0x08bd0000, 0x0fff0000, 0, "pop%c\t%m"},
    {0x049d0004, 0x0fff0fff, 0, "pop%c\t{%12-15r}\t\t; (ldr%c %12-15r, %a)"},
    {0xf57ff044, 0xffffffff, 0, "pssbb"},
    {0x092d0000, 0x0fff0000, 0, "push%c\t%m"},
    {0x052d0004, 0x0fff0fff, 0, "push%c\t{%12-15r}\t\t; (str%c %12-15r, %a)"},
    {0x01000050, 0x0ff00ff0, 0, "qadd%c\t%12-15R, %0-3R, %16-19R"},
    {0x06200f10, 0x0ff00ff0, 0, "qadd16%c\t%12-15R, %16-19R, %0-3R"},
    {0x06200f90, 0x0ff00ff0, 0, "qadd8%c\t%12-15R, %16-19R, %0-3R"},
    {0x06200f30, 0x0ff00ff0, 0, "qasx%c\t%12-15R, %16-19R, %0-3R"},
    {0x01400050, 0x0ff00ff0, 0, "qdadd%c\t%12-15R, %0-3R, %16-19R"},
    {0x01600050, 0x0ff00ff0, 0, "qdsub%c\t%12-15R, %0-3R, %16-19R"},
    {0x06200f50, 0x0ff00ff0, 0, "qsax%c\t%12-15R, %16-19R, %0-3R"},
    {0x01200050, 0x0ff00ff0, 0, "qsub%c\t%12-15R, %0-3R, %16-19R"},
    {0x06200f70, 0x0ff00ff0, 0, "qsub16%c\t%12-15R, %16-19R, %0-3R"},
    {0x06200ff0, 0x0ff00ff0, 0, "qsub8%c\t%12-15R, %16-19R, %0-3R"},
    {0x06ff0f30, 0x0fff0ff0, 0, "rbit%c\t%12-15R, %0-3R"},
    {0x06bf0f30, 0x0fff0ff0, 0, "rev%c\t%12-15R, %0-3R"},
    {0x06bf0fb0, 0x0fff0ff0, 0, "rev16%c\t%12-15R, %0-3R"},
    {0x06ff0fb0, 0x0fff0ff0, 0, "revsh%c\t%12-15R, %0-3R"},
    {0xf8100a00, 0xfe50ffff, 0, "rfe%23?id%24?ba\t%16-19r%21'!"},
    {0x01a00060, 0x0def0060, 0, "ror%20's%c\t%12-15R, %q"},
    {0x01a00060, 0x0def0ff0, 0, "rrx%20's%c\t%12-15r, %0-3r"},
    ...
    {0x06100f10, 0x0ff00ff0, 0, "sadd16%c\t%12-15R, %16-19R, %0-3R"},
    {0x06100f90, 0x0ff00ff0, 0, "sadd8%c\t%12-15R, %16-19R, %0-3R"},
    {0x06100f30, 0x0ff00ff0, 0, "sasx%c\t%12-15R, %16-19R, %0-3R"},
    {0xf57ff070, 0xffffffff, 0, "sb"},
    ...
    {0x0710f010, 0x0ff0f0f0, 0, "sdiv%c\t%16-19r, %0-3r, %8-11r"},
    {0x06800fb0, 0x0ff00ff0, 0, "sel%c\t%12-15R, %16-19R, %0-3R"},
    {0xf1010000, 0xfffffc00, 0, "setend\t%9?ble"},
    {0xf1100000, 0xfffffdff, 0, "setpan\t#%9-9d"},
